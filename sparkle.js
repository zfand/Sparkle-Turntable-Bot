...
function initializeModules() {
	...
	roomid = process.env.ROOM_ID ? process.env.ROOM_ID : config.roomid;

	bot = new Bot(config.botinfo.auth, config.botinfo.userid, roomid);
...
global.webstatusSetup = function() {
